...
export const pocket: ArchetypeParams = {
  ...
  radiusFrac: [0.35, 0.6],
  sharpness: 0.55,
  radius: { kind: "bimodal", small: [18, 70], big: [180, 360], bigChance: 0.18 },
  spinRange: [0.02, 0.12],
...
function soloPreset(params: ArchetypeParams, weight = 0.5): FieldPreset {
  return {
...
export const soloDrift = soloPreset(drift, 0.8);
