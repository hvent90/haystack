...
export const windowDefinitions: WindowDefinition[] = [
  {
    ...
    minWidth: 240,
    minHeight: 160,
    defaultState: { x: 60, y: 62, width: 270, height: 212, open: false, minimized: false, z: 10 },
  },
  {
    key: "scanner",
    label: "Scanner",
    minWidth: 360,
    minHeight: 260,
    defaultState: { x: 344, y: 62, width: 430, height: 360, open: false, minimized: false, z: 20 },
  },
  {
    key: "cargo",
    label: "Cargo",
    minWidth: 280,
    minHeight: 230,
    defaultState: { x: 790, y: 62, width: 310, height: 300, open: false, minimized: false, z: 30 },
  },
  {
    key: "comms",
    label: "Comms",
    minWidth: 330,
    minHeight: 260,
    defaultState: { x: 60, y: 292, width: 410, height: 340, open: false, minimized: false, z: 40 },
  },
  {
    key: "character",
    label: "Character",
    minWidth: 300,
    minHeight: 220,
    defaultState: { x: 488, y: 438, width: 360, height: 250, open: false, minimized: false, z: 50 },
  },
  {
    key: "bases",
    label: "Bases",
